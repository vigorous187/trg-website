...
When a Toronto operator tells us their restaurant "doesn't show up on Google," it's almost never one obscure technical issue — it's usually a fixable gap in [Google Maps SEO](/services/google-maps-seo/) fundamentals. It's one or two of seven specific gaps. The fixes range from 15-minute admin tasks to multi-week projects, but the diagnosis is fast. Walk through these in order.
